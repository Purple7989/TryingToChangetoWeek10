...
void RenderLayer::_AccumulateLighting()
{
	...
	// using shadow related code gives error : C2664 void ShaderProgram::SetUniform(int, const float *, int)': cannot convert argument 2 from 'const T*' to 'const float *'
	/*
